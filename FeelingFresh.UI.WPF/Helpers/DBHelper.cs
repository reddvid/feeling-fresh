...
namespace FeelingFresh.UI.WPF.Helpers
{
  public class DBHelper
  {
    // WARNING: This is a BAD practice - use a more secure way to hold Connection String
    private const string CONNECTION_STRING = "Data Source=den1.mssql7.gear.host;Database=reddviddb;User Id=reddviddb;Password=@Reddavid0-;";
